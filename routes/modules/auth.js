...
const { checkJwtAccessToken, insertCalendarEvent, coverToCalendarFormat } = require('../../middleware/google-calendar.js')
...
router.post('/schedule/:type/:game_id', checkJwtAccessToken, coverToCalendarFormat, insertCalendarEvent, (req, res) => {
